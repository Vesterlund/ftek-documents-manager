  ...
  abstract class FM_BootStart{
    ...
    public function menu(){
      ...
      if($this->menu_data['type'] == 'menu'){
        ...
        add_menu_page( $this->name, $this->name, 'fnollk_files', $this->prefix, array(&$this, 'admin_panel'), $this->url('img/icon-24x24.png'), 8 );
        add_menu_page( $this->name, $this->name, 'finform_files', $this->prefix, array(&$this, 'admin_panel'), $this->url('img/icon-24x24.png'), 9 );
